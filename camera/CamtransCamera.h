...
public:
    ...
    virtual Matrix4x4 getCameraMatrix() const;
...
private:
    //current eye point, look vector, up vector, height angle, aspect ratio, or world to film matrix
    Vector4d m_eye;
    Vector4d m_look;
    Vector4d m_up;
    double m_near;
    ...
    void updateModelViewMatrix(void);
