...
struct CS123SceneColor 
{
    ...
    inline CS123SceneColor operator *= (float rhs) {r*=rhs; g*=rhs; b*=rhs; return *this;}
    inline CS123SceneColor operator *  (float rhs) const {CS123SceneColor c(*this); c.r*=rhs; c.g*=rhs; c.b*=rhs; return c;}
};
...
struct CS123SceneTransformation
{
   ...
   Matrix4x4 MatrixTransform(void) const;
};
